...
router.post('/',multiUpload,Authenticate, adminSettingController.createOrUpdateAdminSetting);

router.delete('/',Authenticate, adminSettingController.deleteAdminSetting);
